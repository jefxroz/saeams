	...
	<div id="menu_acc" class="easyui-accordion" style="width:200px;">
		<div id="menu_pn1"  selected="true" title='Administrar' iconCls="icon-reload" style="padding:10px;">
			<div id="menu2">
			<ul class="menu2">
				...
				<li><a href="ScheduleManagement.php" ><img src="../.././resources/images/schedule_24.png" /> Gestionar Horarios</a></li>
		...
		<div id="menu_pn2" title='Asignar' iconCls="icon-reload" style="padding:10px;">
			<div id="menu2">
			<ul class="menu2">

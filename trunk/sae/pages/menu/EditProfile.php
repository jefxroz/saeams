...
function saveUser()
{
	...
	$('#fm_updateuser').form('submit',{
		...
		success: function(result){
			...
			if (result.success){
				$.messager.alert('Modificacion de perfil Exitoso','Se ha modificado perfil sin Problemas!!!','info');
				$("#")
...
<body>
	...
	<div id="panelm1" class="easyui-panel" title="Datos de acceso"   style="background:#fafafa;">
		...
		<table width="100%" border="0" cellspacing="3" cellpadding="3" >		
				...
				-->
				<tr>
					<td width="35%" align="left"><label for="id_password">* Nueva contrase&ntilde;a: </label></td>
				...
				<tr>
				<td></td>
				<td width="65%" ><label  >Si no se escribe una nueva contrase&ntilde;a no se modifica la actual</label></td>

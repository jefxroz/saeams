...
<head>
<title>Asignarse cursos - SAE-SAP</title>
			...
			<div id="colTwo">
				...
				<table>
					<tr>
						...
						<td><h2>Asignarse cursos en SAE/SAP</h2></td>
					</tr>
				</table>
				<br/>

				<table id="dgcourses" title="Asignar cursos en SAE/SAP" class="easyui-datagrid" style="width:800px;height:400px"
